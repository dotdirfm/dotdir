...
export async function installExtension(bridge: Bridge, publisherUsername: string, extName: string, version: string): Promise<void> {
...
export async function installVSCodeExtension(bridge: Bridge, publisherName: string, extName: string, downloadUrl: string): Promise<void> {
