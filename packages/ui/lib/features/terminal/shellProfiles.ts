import type { Bridge, CwdEscapeMode, TerminalProfile } from "@dotdirfm/ui-bridge";
 ...
 */
export async function resolveShellProfiles(bridge: Bridge, extensions: LoadedExtension[], env: Record<string, string>): Promise<ShellProfilesResult> {
