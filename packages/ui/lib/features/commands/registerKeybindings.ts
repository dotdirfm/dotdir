...
const appBuiltInKeybindings: Keybinding[] = [
  ...
  { command: CURSOR_TOP, key: "ctrl+home", mac: "alt+home", when: "focusEditor" },
  { command: CURSOR_BOTTOM, key: "ctrl+end", mac: "alt+end", when: "focusEditor" },
  ...
  { command: CURSOR_UP_SELECT, key: "shift+up", when: "focusEditor" },
  { command: CURSOR_DOWN_SELECT, key: "shift+down", when: "focusEditor" },
  { command: CURSOR_LEFT_SELECT, key: "shift+left", when: "focusEditor" },
  { command: CURSOR_RIGHT_SELECT, key: "shift+right", when: "focusEditor" },
  { command: CURSOR_HOME_SELECT, key: "shift+home", mac: "cmd+shift+left", when: "focusEditor" },
  { command: CURSOR_END_SELECT, key: "shift+end", mac: "cmd+shift+right", when: "focusEditor" },
  { command: CURSOR_PAGE_UP_SELECT, key: "shift+pageup", when: "focusEditor" },
  { command: CURSOR_PAGE_DOWN_SELECT, key: "shift+pagedown", when: "focusEditor" },
  { command: CURSOR_WORD_LEFT_SELECT, key: "ctrl+shift+left", mac: "alt+shift+left", when: "focusEditor" },
  { command: CURSOR_WORD_RIGHT_SELECT, key: "ctrl+shift+right", mac: "alt+shift+right", when: "focusEditor" },
...
const commandLineKeybindings: Keybinding[] = [
  ...
  { command: CURSOR_LEFT_SELECT, key: "ctrl+shift+left", mac: "cmd+shift+left", when: "focusPanel && commandLineHasText" },
  { command: CURSOR_RIGHT_SELECT, key: "ctrl+shift+right", mac: "cmd+shift+right", when: "focusPanel && commandLineHasText" },
  { command: CURSOR_WORD_LEFT_SELECT, key: "ctrl+alt+shift+left", mac: "cmd+alt+shift+left", when: "focusPanel && commandLineHasText" },
  { command: CURSOR_WORD_RIGHT_SELECT, key: "ctrl+alt+shift+right", mac: "cmd+alt+shift+right", when: "focusPanel && commandLineHasText" },
...
const fileListKeybindings: Keybinding[] = [
  ...
  { command: CURSOR_UP_SELECT, key: "shift+up", when: "focusPanel" },
  { command: CURSOR_DOWN_SELECT, key: "shift+down", when: "focusPanel" },
  { command: CURSOR_LEFT_SELECT, key: "shift+left", when: "focusPanel" },
  { command: CURSOR_RIGHT_SELECT, key: "shift+right", when: "focusPanel" },
  { command: CURSOR_HOME_SELECT, key: "shift+home", when: "focusPanel" },
  { command: CURSOR_END_SELECT, key: "shift+end", when: "focusPanel" },
  { command: CURSOR_PAGE_UP_SELECT, key: "shift+pageup", when: "focusPanel" },
  { command: CURSOR_PAGE_DOWN_SELECT, key: "shift+pagedown", when: "focusPanel" },
