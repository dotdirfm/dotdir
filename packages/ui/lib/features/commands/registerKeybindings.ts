...
const commandLineKeybindings: Keybinding[] = [
  ...
  { command: COMMANDLINE_CURSOR_WORD_LEFT, key: "ctrl+left", mac: "cmd+alt+left", when: "focusPanel && commandLineHasText" },
  { command: COMMANDLINE_CURSOR_WORD_RIGHT, key: "ctrl+right", mac: "cmd+alt+right", when: "focusPanel && commandLineHasText" },
  { command: COMMANDLINE_CURSOR_LEFT, key: "left", mac: "cmd+left", when: "focusPanel && commandLineHasText" },
  { command: COMMANDLINE_CURSOR_RIGHT, key: "right", mac: "cmd+right", when: "focusPanel && commandLineHasText" },
  { command: COMMANDLINE_CURSOR_HOME, key: "home", when: "focusPanel && commandLineHasText" },
  { command: COMMANDLINE_CURSOR_END, key: "end", when: "focusPanel && commandLineHasText" },
