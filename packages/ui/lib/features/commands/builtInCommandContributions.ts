...
export const builtInCommandContributions: CommandContribution[] = [
  ...
  { command: "panel.goToParent", title: "Go to Parent Directory", category: "Navigation" },
  { command: "panel.goHome", title: "Go to Home Directory", category: "Navigation" },

  // ── File ──────────────────────────────────────────────────────────────────
  { command: "panel.refresh", title: "Refresh", category: "File" },
  { command: "newTab", title: "New Tab", category: "File" },
  { command: "closeTab", title: "Close Tab", category: "File" },
  { command: "previewInOppositePanel", title: "Open Quick View in Opposite Panel", shortTitle: "Quick View", category: "File" },
  { command: "editInOppositePanel", title: "Open Editor in Opposite Panel", shortTitle: "Quick Edit", category: "File" },
  ...
  { command: "panel.makeDir", title: "Make Directory", shortTitle: "MkDir", category: "File" },
