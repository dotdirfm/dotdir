...
export const builtInCommandContributions: CommandContribution[] = [
  ...
  { command: "previewInOppositePanel", title: "Open Quick View in Opposite Panel", category: "File" },
  { command: "editInOppositePanel", title: "Open Editor in Opposite Panel", category: "File" },
