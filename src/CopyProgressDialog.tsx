...
export function CopyProgressDialog({
  ...
  return (
    <dialog ref={dialogRef} className="modal-dialog copy-progress-dialog" onCancel={(e) => { e.preventDefault(); onCancel(); }}>
      ...
      <div className="modal-dialog-body">
        ...
        <div className="copy-progress-stats">
          <span>{formatSize(bytesCopied)} / {formatSize(bytesTotal)}</span>
